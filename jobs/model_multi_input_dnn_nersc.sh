#!/bin/bash
#SBATCH --job-name=multi_dnn_jets_tracks
...
#SBATCH --output=../logs/slurm-multi-dnn-%j.out
#SBATCH --error=../logs/slurm-multi-dnn-%j.err
...
# Run the pipeline
echo "Starting Multi-input DNN training with jets and tracks..."
echo "Time started: $(date)"

python scripts/train.py --config-file config/configs/experiment_dnn_with_jets_tracks.yaml

python scripts/evaluate.py --model-dir /pscratch/sd/l/liangyu/vertextiming/models/multi_input_dnn_with_jets_tracks --load-data
