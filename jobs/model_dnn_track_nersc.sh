...
#SBATCH --output=../logs/slurm-dnn-track-%j.out
#SBATCH --error=../logs/slurm-dnn-track-%j.err
...
# Run the pipeline
echo "Starting DNN training with track-matching features..."
echo "Time started: $(date)"

python scripts/train.py --config-file config/configs/experiment_dnn_track.yaml

python scripts/evaluate.py --model-dir /pscratch/sd/l/liangyu/vertextiming/models/dnn_with_tracks --load-data
