...
from ..common.base_model import BaseVertexModel
from ..common.layers import MaskedGlobalAveragePooling1D
from ..common.transformer_layers import PositionalEncoding, MultiHeadSelfAttention, TransformerBlock
...
class TransformerModel(BaseVertexModel):
